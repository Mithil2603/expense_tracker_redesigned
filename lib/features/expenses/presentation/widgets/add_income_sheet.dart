...
/// Opens a bottom sheet to log a new income or edit an existing one.
void showAddIncomeSheet(BuildContext context, {TransactionEntity? transaction}) {
  ...
  IncomeCategory selectedCat = transaction?.incomeCategory ?? IncomeCategory.salary;
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(isEdit ? 'Edit Income Log' : 'Log New Income', style: AppTextStyles.h2),
                        if (isEdit)
                          IconButton(
                    ...
                    AppTextField(
                      ...
                      hint: 'e.g. Monthly bonus included',
                    ...
                    App3DButton(
                      label: isEdit ? 'UPDATE LOG' : 'SAVE INCOME',
                      ...
                      onTap: () {
                        ...
                        Navigator.of(context).pop();
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text(isEdit ? 'Income updated successfully!' : 'Income logged successfully!')),
                        );
                      },
                    ),
