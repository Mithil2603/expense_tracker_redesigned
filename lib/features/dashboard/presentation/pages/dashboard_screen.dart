        ...
        builder: (context, state) {
          ...
          return Column(
            children: [
              ...
              // Executive IPO Capital Hub Banner
              GestureDetector(
                onTap: () => context.pushNamed(AppRoutes.ipoHubName),
                child: Container(
                  margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                  padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 11),
                  decoration: BoxDecoration(
                    color: isLight ? const Color(0xFF0F172A) : const Color(0xFF161B22),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: isLight ? const Color(0xFF1E293B) : const Color(0xFF30363D),
                    ),
                    boxShadow: [
                      BoxShadow(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 2),
                            Text(
                              'ASBA Engine • Delegated Capital (Self, Dad, Mom)',
                              style: TextStyle(
                                fontSize: 11,
