...
class SmsParser {
  ...
  static final Map<String, ExpenseCategory> _expenseCategoryMap = {
    ...
    // Vehicle & Transport (Owned vehicle costs)
    ...
    'youtube': ExpenseCategory.telecomAndRecharges,
    'prime': ExpenseCategory.telecomAndRecharges,
    'disney': ExpenseCategory.telecomAndRecharges,
